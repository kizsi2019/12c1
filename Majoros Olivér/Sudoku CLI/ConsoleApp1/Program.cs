...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sr.Close();
            Console.WriteLine("3. feladat: Beolvasva {0} feladavany", feladvanyok.Count);
            ...
            Console.WriteLine("{0}×{0} méretű feladványból {1} darab van tárolva", meret, nElemuFeladvany.Count);
