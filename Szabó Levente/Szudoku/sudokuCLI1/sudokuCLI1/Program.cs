...
namespace sudokuCLI1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0}x{0} méretű feladvanyból {1} darab van tárolva", meret, nElemuFeladvany.Count);

            Random rand = new Random();
            int index = rand.Next(nElemuFeladvany.Count);
            var kivalasztottFeladvany = nElemuFeladvany[index];

            Console.WriteLine("5. feladat: A kiválastott feladvany:");
            ...
            Console.WriteLine("6. feladat: A feladvány kitöltötsége: {0:f0}% ",100 * db / kivalasztottFeladvany.Kezdo.Length);
            ...
            Console.WriteLine("8. feladat: {0} állomány {1} drab feladvánnyal létrehozva", fajlNev, nElemuFeladvany.Count);
            sw.Close();
        }
    }
}
